...
# Parâmetros
arquivo_srt = "traduzido_ptb.srt"
voz = "pt-BR-AntonioNeural"  # Outras opções: en-US-JennyNeural, en-US-AriaNeural
pasta_temp = "audios_temp"
arquivo_saida = "output_final_br.mp3"
...
print(f"\n✅ Português gerado: {arquivo_saida}")
