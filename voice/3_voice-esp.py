...
# Parâmetros
arquivo_srt = "voiceover_esp.srt"  # Legendas em espanhol
voz = "es-ES-AlvaroNeural"  # Outras opções: es-ES-ElviraNeural, es-MX-DaliaNeural, es-CO-GonzaloNeural
pasta_temp = "audios_temp"
arquivo_saida = "output_final_es.mp3"
...
print("Generando locuciones en español...")
...
print(f"\n✅ Doblaje en español generado: {arquivo_saida}")
